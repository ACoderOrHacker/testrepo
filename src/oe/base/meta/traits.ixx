...
#    error "oe.base.meta.traits only supports C++11 or newer"
#endif

export module oe.base.meta.traits;

import oe.base.unreachable;
...
template <typename T> std::add_rvalue_reference_t<T> declval() noexcept {
    static_assert(!std::is_same_v<T, T>, "declval not allowed in an evaluated context");
    oe::base::unreachable();
}
