...
struct define_char_traits {
    ...
    static constexpr inline bool eq_int_type(int_type a, int_type b) noexcept { return a == b; }
    ...
    static constexpr inline int compare(const char_type* a, const char_type* b,
                                        oe::usize n) noexcept {
        return base::memcmp(a, b, n);
    }

    static constexpr inline const char_type* find(const char_type* s, oe::usize n,
    ...
    static constexpr inline char_type* copy(char_type* dest, const char_type* src,
                                            oe::usize n) noexcept {
        return base::memcpy(dest, src, n);
    }

    static constexpr inline char_type* move(char_type* dest, const char_type* src,
                                            oe::usize n) noexcept {
        return base::memmove(dest, src, n);
    }

    static constexpr inline void assign(char_type& c, char_type value) noexcept { c = value; }

    static constexpr inline char_type* assign(char_type* dest, oe::usize n, char_type c) noexcept {
        // TODO: a faster way?
    ...
    static constexpr inline int_type not_eof(int_type i) noexcept { return i != eof() ? i : eof(); }
};
} // namespace oe::details