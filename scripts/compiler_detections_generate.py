#!/usr/bin/env python3
# generate_compiler_detections.py
...
compilers = [
    ...
    {
        "macro": "OE_COMPILER_AZTEC_C",
        "condition": "defined(AZTEC_C) || defined(__AZTEC_C__)",
    },
    {
        "macro": "OE_COMPILER_BORLAND_CPP",
        "condition": "defined(__BORLANDC__) || defined(__CODEGEARC__)",
    },
    {"macro": "OE_COMPILER_CC65", "condition": "defined(CC65)"},
    {
        "macro": "OE_COMPILER_IBM_XL_C_CPP",
        "condition": "defined(__ibmxl__) || defined(__xlC__)",
    },
    ...
    {
        "macro": "OE_COMPILER_COMPAQ_C",
        "condition": "defined(__DECC) || defined(__VAXC) || defined(VAXC)",
    },
    ...
    {
        "macro": "OE_COMPILER_DJGPP",
        "condition": "defined(__DJGPP__) || defined(__GO32__)",
    },
    ...
    {
        "macro": "OE_COMPILER_KEIL_CARM",
        "condition": "defined(__CA__) || defined(__KEIL__)",
    },
    {"macro": "OE_COMPILER_KEIL_C166", "condition": "defined(__C166__)"},
    {
        "macro": "OE_COMPILER_KEIL_C51",
        "condition": "defined(__C51__) || defined(__CX51__)",
    },
    {"macro": "OE_COMPILER_LCC", "condition": "defined(__LCC__)"},
    {"macro": "OE_COMPILER_METAWARE_HIGH_C_CPP", "condition": "defined(__HIGHC__)"},
    {
        "macro": "OE_COMPILER_METROWERKS_CODEWARRIOR",
        "condition": "defined(__MWERKS__) || defined(__CWCC__)",
    },
    {"macro": "OE_COMPILER_MSVC", "condition": "defined(_MSC_VER)"},
    {"macro": "OE_COMPILER_MICROTEC_C_CPP", "condition": "defined(__MRI)"},
    {
        "macro": "OE_COMPILER_MICROWAY_NDP_C",
        "condition": "defined(__NDPC__) || defined(__NDPX__)",
    },
    ...
    {
        "macro": "OE_COMPILER_MPW_CPP",
        "condition": "defined(__MRC__) || defined(MPW_C) || defined(MPW_CPLUS)",
    },
    {"macro": "OE_COMPILER_NORCROFT_C", "condition": "defined(__CC_NORCROFT)"},
    {"macro": "OE_COMPILER_NWCC", "condition": "defined(NWCC)"},
    {
        "macro": "OE_COMPILER_OPEN64",
        "condition": "defined(__OPEN64__) || defined(__OPENCC__)",
    },
    {"macro": "OE_COMPILER_ORACLE_PROC", "condition": "defined(ORA_PROC)"},
    {
        "macro": "OE_COMPILER_ORACLE_SOLARIS_STUDIO_C",
        "condition": "defined(__SUNPRO_C)",
    },
    {
        "macro": "OE_COMPILER_ORACLE_SOLARIS_STUDIO_CPP",
        "condition": "defined(__SUBPRO_CC)",
    },
    ...
    {
        "macro": "OE_COMPILER_RENESAS",
        "condition": "defined(__RENESAS__) && defined(__HITACHI__)",
    },
    {
        "macro": "OE_COMPILER_SAS_C",
        "condition": "defined(SASC) || defined(__SASC) || defined(__SASC__)",
    },
    ...
    {
        "macro": "OE_COMPILER_THINKC",
        "condition": "defined(THINKC3) || defined(THINKC4)",
    },
...
output_lines = [
    ...
    f" * @copyright Copyright (C) {datetime.datetime.now(tz=datetime.timezone.utc).year} ACoderOrHacker. All rights reserved.",
    " */",
...
for idx, comp in enumerate(compilers, start=1):
    output_lines.append(f"#define {comp['macro']} {idx}")

output_lines.append("")
output_lines.append("/* Define OE_COMPILER_SINGLE based on detection */")
output_lines.append("#if " + compilers[0]["condition"])

for comp in compilers[1:]:
    output_lines.append(f"#elif {comp['condition']}")
    output_lines.append(f"#define OE_COMPILER_SINGLE {comp['macro']}")

single_parts = []
single_parts.append("#if " + compilers[0]["condition"])
single_parts.append(f"#define OE_COMPILER_SINGLE {compilers[0]['macro']}")
for comp in compilers[1:]:
    single_parts.append(f"#elif {comp['condition']}")
    single_parts.append(f"#define OE_COMPILER_SINGLE {comp['macro']}")
single_parts.append("#else")
single_parts.append('#error "Unknown compiler"')
single_parts.append("#endif")

output_lines.extend(single_parts)
...
for comp in compilers:
    base = comp["macro"].replace("OE_COMPILER_", "")
    output_lines.append(f"#if {comp['condition']}")
    output_lines.append(f"#define OE_HAS_{base}_COMPILER_ID 1")
    output_lines.append("#endif")

output_lines.append("")
output_lines.append("#endif /* OE_DETECTIONS_COMPILER_DETECTIONS_H */")
...
target_file = os.path.join(target_dir, "compiler_detections.h")
